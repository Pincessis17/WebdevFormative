...
('Cyclops', 'Scott Summers', 'Field leader of the X-Men with optic blasts.',
 ...
 'Optic blasts, tactical genius', 'X-Men', 'Marvel Comics', 'Male', 'Active', 'https://kommodo.ai/i/I5e0PGlF3H5T54VwVfpy'),
...
('Jean Grey', 'Jean Grey-Summers', 'Powerful telepath and telekinetic, host of the Phoenix Force.',
 ...
 'Telepathy, telekinesis, Phoenix Force', 'X-Men', 'Marvel Comics', 'Female', 'Active', 'https://kommodo.ai/i/8LtwI7Z54V6umFJn0i08'),
...
('Wolverine', 'James "Logan" Howlett', 'Feral mutant with a healing factor and adamantium claws.',
 ...
 'Healing factor, adamantium claws, enhanced senses', 'X-Men', 'Marvel Comics', 'Male', 'Active', 'https://kommodo.ai/i/NimPX1mujrF1XowdYWg4'),
...
('Storm', 'Ororo Munroe', 'Mutant who can control and manipulate the weather.',
 ...
 'Weather manipulation, flight', 'X-Men', 'Marvel Comics', 'Female', 'Active', 'https://kommodo.ai/i/yMqmcAPjVjTRBC0nwXDS'),
...
('Beast', 'Henry "Hank" McCoy', 'Genius scientist with ape-like agility and strength.',
 ...
 'Superhuman strength and agility, genius intellect', 'X-Men', 'Marvel Comics', 'Male', 'Active', 'https://kommodo.ai/i/ITFSUf7EDfmWUYI6dZ5q'),
...
('Professor X', 'Charles Francis Xavier', 'Founder of the X-Men and the world''s most powerful telepath.',
 ...
 'Telepathy, psychic shields, astral projection', 'X-Men', 'Marvel Comics', 'Male', 'Active', 'https://kommodo.ai/i/OxXHUUvFp5qT31yHJ6Iq');
